    ...
    <div class="footer-grad">
        <div class="footer-grad-content footer-grad-contact">
            ...
            <p class="footer-grad-subcontent contact-content">Email : info@keuperedu.com</p>
        ...
        <div class="footer-grad-content footer-grad-center">
            ...
            <a class="footer-grad-content-center-creator footer-grad-subcontent" href="./admin">Admin</a>
